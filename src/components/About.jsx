        ...
        <div className="about-content">
          <div className="about-text">
            <p className="about-description">
              فريق <strong>Activity Cyber-Department</strong> هو وحدة الأمن السيبراني التطوعية التابعة لمركز <strong>اكتفتي</strong> التابع لاتحاد بشبابها. نحن مجموعة من المهتمين بالأمن الرقمي والتقنية، نعمل على تطوير المهارات الامنية و توعية شباب و اجيال المستقبل لاهمية الامن السيبراني و الثغرات الأمنية وحماية البنية التحتية الرقمية.
            </p>
            <p className="about-description">
